...
const sources: Source[] = [
  { name: 'Satellite imagery', provider: 'ISRO Bhuvan', href: 'https://bhuvan-app1.nrsc.gov.in/', icon: Satellite, live: false },
  { name: 'Weather + forecast', provider: 'IMD', href: 'https://mausam.imd.gov.in/', icon: Wifi, live: false },
  { name: 'Rainfall', provider: 'IMD rainfall', href: 'https://mausam.imd.gov.in/', icon: Waves, live: false },
  { name: 'River / water level', provider: 'CWC flood forecast', href: 'https://ffs.india-water.gov.in/', icon: Waves, live: false },
  { name: 'Historical disaster data', provider: 'NDMA India', href: 'https://ndma.gov.in/', icon: Wifi, live: false },
  { name: 'Soil + terrain', provider: 'ISRO Bhuvan', href: 'https://bhuvan-app1.nrsc.gov.in/', icon: Sprout, live: false },
  { name: 'Population density', provider: 'Census India', href: 'https://censusindia.gov.in/', icon: Users, live: false },
  { name: 'Road + infrastructure', provider: 'OpenStreetMap', href: 'https://www.openstreetmap.org/', icon: Route, live: false },
  { name: 'Fire / stubble burning', provider: 'NASA FIRMS', href: 'https://firms.modaps.eosdis.nasa.gov/map/', icon: Flame, live: true },
