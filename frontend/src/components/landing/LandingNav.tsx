      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 text-xs text-slate-300 hover:text-white border border-white/10 hover:border-white/20 rounded-md transition-all bg-white/[0.02] hover:bg-white/[0.05]"
          ...
          <Link
            href="/workbench"
            className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 text-xs font-semibold text-slate-950 bg-sky-400 hover:bg-sky-300 rounded-md transition-all shadow-[0_0_20px_rgba(56,189,248,0.25)] hover:shadow-[0_0_25px_rgba(56,189,248,0.4)] whitespace-nowrap"
          >
            <span className="hidden sm:inline">Open Live Console</span>
            <span className="sm:hidden">Live Console</span>
